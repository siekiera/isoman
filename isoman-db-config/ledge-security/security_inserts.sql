...
--# Isoman roles
INSERT INTO SECURITY_ROLE (ROLE_ID, ROLE_NAME) VALUES (101, 'systemadmin');
INSERT INTO SECURITY_ROLE (ROLE_ID, ROLE_NAME) VALUES (102, 'author');
INSERT INTO SECURITY_ROLE (ROLE_ID, ROLE_NAME) VALUES (104, 'student');
...
INSERT INTO SECURITY_USER_RESOURCE_GROUP_ROLE ( USER_ID, RESOURCE_GROUP_ID, ROLE_ID ) VALUES (101, 1, 102);
INSERT INTO SECURITY_USER_RESOURCE_GROUP_ROLE ( USER_ID, RESOURCE_GROUP_ID, ROLE_ID ) VALUES (101, 1, 104);
--wykładowca
INSERT INTO SECURITY_USER_RESOURCE_GROUP_ROLE ( USER_ID, RESOURCE_GROUP_ID, ROLE_ID ) VALUES (102, 1, 102);
--doktorant
INSERT INTO SECURITY_USER_RESOURCE_GROUP_ROLE ( USER_ID, RESOURCE_GROUP_ID, ROLE_ID ) VALUES (103, 1, 102);
INSERT INTO SECURITY_USER_RESOURCE_GROUP_ROLE ( USER_ID, RESOURCE_GROUP_ID, ROLE_ID ) VALUES (103, 1, 104);
--student
INSERT INTO SECURITY_USER_RESOURCE_GROUP_ROLE ( USER_ID, RESOURCE_GROUP_ID, ROLE_ID ) VALUES (104, 1, 104);

--# Isoman permissions
INSERT INTO SECURITY_PERMISSION (PERMISSION_ID, PERMISSION_NAME, PERMISSION_DESC)  VALUES  (101, 'manage_persons', 'Uprawnienie do zarządzania osobami');
INSERT INTO SECURITY_PERMISSION (PERMISSION_ID, PERMISSION_NAME, PERMISSION_DESC)  VALUES  (110, 'update_archives', 'Uprawnienie aktualizacji archiwów');
INSERT INTO SECURITY_PERMISSION (PERMISSION_ID, PERMISSION_NAME, PERMISSION_DESC)  VALUES  (120, 'manage_subjects', 'Uprawnienie do zarządzania przedmiotami');
INSERT INTO SECURITY_PERMISSION (PERMISSION_ID, PERMISSION_NAME, PERMISSION_DESC)  VALUES  (401, 'view_subjects', 'Uprawnienie do wyświetlenia listy przedmiotów');
INSERT INTO SECURITY_PERMISSION (PERMISSION_ID, PERMISSION_NAME, PERMISSION_DESC)  VALUES  (410, 'view_archives', 'Uprawnienie do wyświetlenia listy archiwów');
INSERT INTO SECURITY_PERMISSION (PERMISSION_ID, PERMISSION_NAME, PERMISSION_DESC)  VALUES  (411, 'download_archives', 'Uprawnienie do pobierania archiwów');

INSERT INTO SECURITY_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID) VALUES (101, 101);
INSERT INTO SECURITY_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID) VALUES (101, 110);
INSERT INTO SECURITY_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID) VALUES (101, 120);

INSERT INTO SECURITY_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID) VALUES (104, 401);
INSERT INTO SECURITY_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID) VALUES (104, 410);
INSERT INTO SECURITY_ROLE_PERMISSION (ROLE_ID,PERMISSION_ID) VALUES (104, 411);
